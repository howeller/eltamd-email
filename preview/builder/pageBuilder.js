...
function checkForBackUp()
{
    ...
    {
        if ( QueryString.backup == "true" )
        {
            createBannerStatic( QueryString );
        }
        else
        {
            var arrBackUpSize = QueryString.backup.split("x");
            var objBackUpSize = new Object();
                objBackUpSize.w = arrBackUpSize[0];
                objBackUpSize.h = arrBackUpSize[1];

            createBannerStatic( objBackUpSize );
        }
    }
}
