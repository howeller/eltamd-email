...
/*
	Get the path to where the image is hosted. Toggle between local and CDN.
*/
/*function serverPath (imagePath){
	// console.log(this.image_path);
	let _path = (_testing && this[imagePath]) ? this[imagePath] : '';
	return _path;
}*/
...
exports.formatCtaTxt = formatCtaTxt;
exports.formatList = formatList;
exports.formatParagraph = formatParagraph;
exports.formatParagraphWithTags = formatParagraphWithTags;
exports.replaceLastSpace = replaceLastSpace;
